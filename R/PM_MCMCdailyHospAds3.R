...
PM_MCMCCOVIDdailyHospAds3.ADAPTIVE = function(dailyHospAdmissions, P0, theta0, priors, simulator, noSims,
...
PM_MCMCCOVIDdailyHospAds3 = function(dailyHospAdmissions, P0, theta0, priors, simulator, lambda, V, noSims, noIts,
                              burnIn){
