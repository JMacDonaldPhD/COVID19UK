rm(list = ls())
setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 6 (N = 200, scaled)/")

load("epidemic 6.RData")



setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 6 (N = 200, scaled)/Testing Scheme 1/")
...
set.seed(1)
obsParam <- c(alpha = .2, pi = .9, psi = .98)
obsWindow <- c(0, 1)
