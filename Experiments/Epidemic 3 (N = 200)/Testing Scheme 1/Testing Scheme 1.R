rm(list = ls())
setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 3 (N = 200)/")

load("epidemic 3.RData")



setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 3 (N = 200)/Testing Scheme 1/")
...
set.seed(1)
obsParam <- c(alpha = .3, pi = .9, psi = .98)
obsWindow <- c(0, 1)
