...
rm(list = ls())
setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 2 (N = 100)")
...
simParam <- c(beta_G = 0.2, beta_H = 0.25, gamma = 0.5)
...
hist.default(noInfectionsInFirstDay, breaks = 0:max(noInfectionsInFirstDay), main = "Number of Infections on Day 1",
             right = F)
hist.default(noInfectionsInFirstDay2, breaks = 0:max(noInfectionsInFirstDay2), main = "Number of Infections on Day 1",
             right = F)
...
save.image(file = "epidemic 2.RData")
