rm(list = ls())
setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 7 (N = 400, scaled)/")

load("epidemic 7.RData")



setwd("C:/Users/Josh/git/COVID19UK/Experiments/Epidemic 7 (N = 400, scaled)/Testing Scheme 1/")
...
set.seed(1)
obsParam <- c(alpha = .1, pi = .9, psi = .98)
obsWindow <- c(0, 1)
