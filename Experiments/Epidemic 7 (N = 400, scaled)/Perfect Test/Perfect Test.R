rm(list = ls())
setwd("C:/Users/Work/Documents/git/COVID19UK/Experiments/Epidemic 7 (N = 400, scaled)/")

load("epidemic 7.RData")



setwd("C:/Users/Work/Documents/git/COVID19UK/Experiments/Epidemic 7 (N = 400, scaled)/Perfect Test/")
...
totalNegTestsBounds <- rep(mean(totalNegTests), 2) + c(-1, 1)
totalPosTestsBounds <- rep(mean(totalPosTests), 2) + c(-1, 1)

totalTestsBounds <- rep(mean(totalTests)) + c(-1, 1)
...
save.image(file = "Perfect Test.RData")
