...
setwd("C:/Users/Work/Documents/git/COVID19UK/Experiments/Epidemic 8 (N = 400, scaled)/Testing (Perfect)/Testing Scheme (alpha = 0.1)/")
...
save.image(file = "Testing Scheme (alpha = 0.1).RData")
