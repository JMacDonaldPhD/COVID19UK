...
setwd("C:/Users/Work/Documents/git/COVID19UK/Experiments/Epidemic 8 (N = 400, scaled)/Testing (Perfect)/Testing Scheme (alpha = 0.25)/")
...
obsParam <- c(alpha = .25, pi = .9, psi = .98)
obsWindow <- c(0, 1)
...
save.image(file = "Testing Scheme (alpha = 0.25).RData")
